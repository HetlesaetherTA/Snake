function Settings() {
    ...
    this.speedSlider.position(window.innerWidth * 0.699,this.settingsHeight)
    ...
    this.sizeSlider.position(window.innerWidth * 0.699,this.settingsHeight + 35)
    this.sizeSlider.addClass("setting")
    // ai on/off setting
    this.aiSlider = createSlider(0,1,0,1);
    this.aiSlider.position(window.innerWidth * 0.27, this.settingsHeight + 17.5)
